    ...
    <main className="pt-24">
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            <h1 className="font-heading text-4xl md:text-5xl font-bold text-foreground mb-4">Contacto</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              ¿Tienes un proyecto de reforma en mente? Cuéntanos qué necesitas y te preparamos una propuesta adaptada.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 max-w-5xl mx-auto">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-card rounded-2xl p-8 border border-border space-y-6">
                <h3 className="font-heading text-lg font-bold text-foreground">Datos de contacto</h3>
              ...
              <div className="bg-card rounded-2xl overflow-hidden border border-border aspect-[4/3]">
                <iframe
                  ...
                  title="Ubicación M&M Reformas Integrales en Cervelló"
                />
              </div>
            </div>
          </div>
